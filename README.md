...
![TODO: Update the path with the name of your diagram](~/Desktop/ELK-Stack-Project/ELK-Visual.PNG)
...
Integrating an ELK server allows users to easily monitor the vulnerable VMs for changes to the __web traffic___ and system __logs___.
